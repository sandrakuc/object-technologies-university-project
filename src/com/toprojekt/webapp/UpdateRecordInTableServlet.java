...
@WebServlet(name = "UpdateInTableResult", urlPatterns = {"/UpdateInTableResult"})
public class UpdateRecordInTableServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        values.add("333");
        values.add("'example123'");
        List<String> columns = client.getTableColumnsNames("0");
        List<String> record = client.updateToTable("0", "333", values);
        ...
        o.println("<h2 align='center' style='font-weight: bold; font-size: 20px;'>Zaktualizowano rekord</h2>");
        o.println("</div>");
