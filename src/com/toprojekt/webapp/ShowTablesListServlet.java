...
@WebServlet(name = "ShowTablesList", urlPatterns = {"/ShowTablesList"})
public class ShowTablesListServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<String> tables = client.getDatabaseTables();
        ...
        o.println("<h2 align='center' style='font-weight: bold; font-size: 20px;'>Lista tabeli bazy danych</h2>");
        o.println("</div>");
        o.println("<div style='margin-left:auto; margin-right: auto; margin-top: 50px;' align='center'>");
        o.println("<ul>");
        for(String table: tables){
            o.println("<li>" + table + "</li>");
        }
        o.println("</ul>");
        o.println("</div>");
        o.println("</div>");
